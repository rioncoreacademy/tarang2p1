// Tarang2_dp1 — rebrands the stock noVNC connect screen.
//
...
// hide just that, in place — a no-op if no such element exists. Hidden
// rather than relabeled: the RionCore Academy background image (see
// Dockerfile) already carries the branding, so a second on-screen logo
// just visually collides with the artwork behind it.
(function () {
  function relabel() {
