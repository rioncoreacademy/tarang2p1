...
# tarang2p1-tree model for projects like tarang2_dp1, to remove the
# start/work/exit friction of that workflow.
#
# Editing still goes through gvim (tarang2p1-crypt.vim) when working
...
# Wait for the key — tarang2p1-key-init.sh may still be fetching it,
